        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            ?>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputname" placeholder="<?php echo $row['subcategory'];?>" name="name">
                  </div>                  
                </div>
                <!-- /.card-body -->
            ...
            <?php
                        if(isset($_POST['btn'])){
                            $name=$_POST['name'];
                            $editquery = "UPDATE subcategory SET subcategory='$name' WHERE scatid='$q' ";
                            if(mysqli_query($con, $editquery))
                            {
                                echo "<script>
                                alert('data updated !! ');window.location.href='AddSubCategory.php';</script>";
                            }
                            else
                            {
                            echo "<script>
