...
?>
              ...
              <a href="AllBooking.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                while($row=mysqli_fetch_assoc($res))
                {
                    ...
                    $queryselectcake="select * from service where  slno = '$pid'";
                    $rescake=mysqli_query($con,$queryselectcake);
                    $rowcake=mysqli_fetch_assoc($rescake);
                    $s=$s+$rowcake['price'];
                }
                echo $s;
                
?>
                  <sup style="font-size: 20px">Rs</sup></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="AllRegistrations.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
